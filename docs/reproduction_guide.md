...
The bundled `app/prolexbase.db` contains the Arabic lexical data used by the local exploration and rule-based generation views. MySQL-dependent semantic-relation views are optional and degrade gracefully when no MySQL configuration is present.
