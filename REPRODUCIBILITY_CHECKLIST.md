...
- The current Streamlit Extraction & Classification view uses a Groq-compatible LLM for both candidate proper-name extraction and semantic-type assignment.
- CAMeL Tools is not required to run the public demo.
- The deterministic morphology, ProLMF, RDF, and SPARQL checks remain independent of the external LLM.
- Evaluation boundaries and limitations are documented in `docs/evaluation_and_scope.md`.
